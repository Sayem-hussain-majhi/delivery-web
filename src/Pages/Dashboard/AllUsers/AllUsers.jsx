                    ...
                    <tbody>
                        {/* row 1 */}
                        {
                         ...
                         <td className=' space-x-2'>
                            ...
                            { !user.role ===  'admin' ? ' Admin' : <input onClick={()=>handleMakeAdmin(user)} className='p-2 text-md font-semibold text-teal-600 hover:bg-teal-500 hover:text-white duration-200  border-2 border-teal-400 rounded-lg my-2' type="button" value="Make Admin" />}
